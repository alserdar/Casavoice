...
// ------------------------------------------>
     ...
     */
    @VisibleForTesting
    protected static void addStringParam(@NonNull ByteArrayOutputStream os, @NonNull String value) {
     ...
     */
    @VisibleForTesting
    protected static void addBooleanParam(@NonNull ByteArrayOutputStream os, boolean value) {
        // Param type
     ...
     */
    @VisibleForTesting
    protected static void addNullParam(@NonNull ByteArrayOutputStream os) {
...
// ------------------------------------------>
    ...
    private static boolean isEndOfObject(int offset, @NonNull byte[] buffer)
    {
        ...
        if( value == 0 && buffer.length >= offset+1 )
        {
            ...
            return value2 == 0 && value3 == ParamType.END_OF_OBJECT.value;
        }
